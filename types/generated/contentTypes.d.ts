...
export interface ApiDisbursementDisbursement
  extends Struct.CollectionTypeSchema {
  collectionName: 'disbursements';
  info: {
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    disbursements: Schema.Attribute.Relation<
      'oneToMany',
      'api::disbursement.disbursement'
    >;
    ...
    > &
      Schema.Attribute.Private;
    project_updates: Schema.Attribute.Relation<
      'oneToMany',
      'api::project-update.project-update'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::disbursement.disbursement': ApiDisbursementDisbursement;
